...
def handler_for(app):
    class Handler(BaseHTTPRequestHandler):
        ...
        def do_GET(self):
            ...
            if path in {"/", "/app.js", "/style.css", "/diagnostics.js", "/templates.js", "/query.js", "/ordered.js", "/controls.js", "/history.html", "/history.js", "/favicon.svg", "/vendor/jquery-3.7.1.min.js", "/vendor/select2-4.0.13.min.js", "/vendor/select2-4.0.13.min.css"}:
