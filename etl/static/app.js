...
function renderColumns() {
  ...
  // An empty draft has no field pipeline to describe yet, nor anything to
  // select or bulk-transform.
  $("stage-guide").hidden = !definition.columns.length;
  $("bulk-transforms").hidden = !definition.columns.length;
